...
export const QUEST_DEFINITIONS = Object.freeze({
  ...
  "coffee-perfect": {
    ...
    short: "Trefft fünfmal die immer kleinere goldene Mitte.",
    intro: "Kaffeeduft! Meiner ist natürlich nur ein capyfreundlicher Hafer-Milchschaum.",
    instruction: "Stoppe den Punkt fünfmal im goldenen Bereich. Die perfekte Mitte wird jede Runde kleiner.",
  ...
  "city-tour": {
    ...
    short: "Merkt euch eine Strecke und findet gemeinsam den Weg.",
    intro: "Rucksack gepackt? Ich bin gern unterwegs – solange wir zusammen gehen.",
    instruction: "Merke dir die fünf Stationen. Danach wird die Strecke verdeckt und ihr lauft sie gemeinsam ab.",
  ...
  "pond-rhythm": {
    ...
    short: "Merkt euch die Melodie auf sechs bunten Seerosen.",
    intro: "Die Seerosen spielen Musik! Können wir ihre Melodie nachklopfen?",
    instruction: "Merke dir die leuchtende Folge auf sechs Seerosen und tippe sie richtig nach.",
